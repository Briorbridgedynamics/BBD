...
export const Promises = () => {
  return (
    <div className="flex flex-col h-auto bg-dark  font-Roboto_Condensed pb-32">
      <div
        className={`lg:py-16 md:py-6 flex items-center text-transparent w-[100%] text-[140px] font-bold justify-center text-center bg-clip-text bg-gradient-to-t from-g6 to-g5 ${robot}`}
      >
        OUR PROMISE'S
      </div>
      <div className="grid sm:grid-cols-2 lg:gap-12 md:gap-6 lg:m-16 md:m-6 ">
        <div className=" flex flex-col lg:min-h-[650px] w-full bg-g6 rounded-[42px] items-center justify-center lg:py-8 md:py-2">
        ...
        <div className="flex flex-col min-h-[650px] w-full bg-g6 rounded-[42px] items-center justify-center lg:py-8 md:py-2">
          <div className=" w-full">
            <Image
              src={PR}
              alt=""
      ...
      <div className=" flex min-h-[450px] w-auto  bg-g6 rounded-[42px] items-center justify-center py-4 lg:mx-16 md:mx-8">
        <div className="w-[50%]">
          <div className="text-dark font-bold lg:text-[40px] md:text-[30px]  text-center">
            Customer Satisfaction
          </div>
          <div className="text-dark  text-lg text-center p-6 lg:w-[70%] md:w-[90%] mx-auto ">
